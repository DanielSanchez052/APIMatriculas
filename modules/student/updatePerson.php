...
if($conn->connect_error){
    ...
    $sql = "UPDATE person SET name='$name',last_name='$last_name',second_last_name='$second_last_name',city='$city',direction='$direction',phone_number='$phone_number',date_born='$date_born',gender='$gender',person_type='$person_type',password='$password' WHERE identification_number='$identification_number' and person_type='student'";
