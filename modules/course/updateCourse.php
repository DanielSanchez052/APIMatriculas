...
if($conn->connect_error){
    ...
    $sql = "UPDATE course SET name='$name',credit='$credit',type='$type',course='$credit',semestre='$semestre',id_teacher='$id_teacher',id_grade='$id_grade' WHERE id_course=$id_course";

    if(mysqli_query($conn,$sql)){
        $res['message']="Se ha actualizado el curso correctamente";
